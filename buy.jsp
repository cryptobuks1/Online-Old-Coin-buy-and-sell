...
sid:<input type="text" name="sid" value=<%=request.getParameter("sid") %>><br>
bid<input type="text" name="bid" value=<%=request.getParameter("bid") %>><br>
pid<input type="text" name="pid" value=<%=request.getParameter("pid") %>><br>
