...
product name<input type="text" name="productname" value="<%=request.getParameter("ppn")%>"disabled>
quantity<input type="text" name="quantity" value=1><%=quantity%><br><br>
price<input type="text" name="productprice" value="<%=request.getParameter("ppc")%>"disabled>
